...
HD_PWD='C:/Verilog-lab/project_stopwatch/project_stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_cnt_disp_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source btn_cnt_disp_test.tcl -notrace
