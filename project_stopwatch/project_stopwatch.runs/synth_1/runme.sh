...
HD_PWD='C:/Verilog-lab/project_stopwatch/project_stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_cnt_disp_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source btn_cnt_disp_test.tcl
