...
HD_PWD='C:/Verilog-lab/my_fsm/my_fsm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_fsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_fsm.tcl -notrace
