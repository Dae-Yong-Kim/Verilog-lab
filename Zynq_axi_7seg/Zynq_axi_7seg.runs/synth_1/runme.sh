...
HD_PWD='C:/Verilog-lab/Zynq_axi_7seg/Zynq_axi_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_axi_7seg_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_axi_7seg_wrapper.tcl
