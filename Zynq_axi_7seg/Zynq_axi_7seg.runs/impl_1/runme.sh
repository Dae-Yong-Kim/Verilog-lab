...
HD_PWD='C:/Verilog-lab/Zynq_axi_7seg/Zynq_axi_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_axi_7seg_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zynq_axi_7seg_wrapper.tcl -notrace
