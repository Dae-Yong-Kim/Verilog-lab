...
HD_PWD='C:/Verilog-lab/my_cnt32/my_cnt32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_cnt32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_cnt32.tcl
