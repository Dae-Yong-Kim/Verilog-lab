...
HD_PWD='C:/Verilog-lab/my_cnt32/my_cnt32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_cnt32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_cnt32.tcl -notrace
