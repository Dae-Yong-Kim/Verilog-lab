...
HD_PWD='C:/Verilog-lab/zynq_basic_system/zynq_basic_system.runs/zynq_basys_myip_slave_lite_v1_0_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_basys_myip_slave_lite_v1_0_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_basys_myip_slave_lite_v1_0_0_1.tcl
