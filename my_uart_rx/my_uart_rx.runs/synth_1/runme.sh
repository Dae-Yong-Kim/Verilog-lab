...
HD_PWD='C:/Verilog-lab/my_uart_rx/my_uart_rx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_uart_rx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_uart_rx.tcl
