...
HD_PWD='C:/Verilog-lab/my_uart_rx/my_uart_rx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_uart_rx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_uart_rx.tcl -notrace
