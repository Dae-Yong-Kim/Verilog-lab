...
HD_PWD='C:/Verilog-lab/AXI_UART/AXI_UART.runs/AXI_UART_BD_my_uart_rx_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_UART_BD_my_uart_rx_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_UART_BD_my_uart_rx_0_0.tcl
