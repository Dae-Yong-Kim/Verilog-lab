...
HD_PWD='C:/Verilog-lab/AXI_UART/AXI_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_UART_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_UART_BD_wrapper.tcl -notrace
