...
HD_PWD='C:/Verilog-lab/AXI_UART/AXI_UART.runs/AXI_UART_BD_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_UART_BD_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_UART_BD_processing_system7_0_1.tcl
