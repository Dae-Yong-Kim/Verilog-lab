...
HD_PWD='C:/Verilog-lab/king/king.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log king_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source king_bd_wrapper.tcl -notrace
