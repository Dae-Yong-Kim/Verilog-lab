...
HD_PWD='C:/Verilog-lab/king/king.runs/king_bd_my_uart_tx_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log king_bd_my_uart_tx_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source king_bd_my_uart_tx_0_0.tcl
