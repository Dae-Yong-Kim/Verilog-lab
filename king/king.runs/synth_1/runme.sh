...
HD_PWD='C:/Verilog-lab/king/king.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log king_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source king_bd_wrapper.tcl
