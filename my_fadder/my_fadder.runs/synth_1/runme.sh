...
HD_PWD='C:/Verilog-lab/my_fadder/my_fadder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_fadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_fadder.tcl
