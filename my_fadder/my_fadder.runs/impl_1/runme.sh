...
HD_PWD='C:/Verilog-lab/my_fadder/my_fadder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_fadder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_fadder.tcl -notrace
