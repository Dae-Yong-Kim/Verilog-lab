...
HD_PWD='C:/Verilog-lab/my_SPI_RAM/my_SPI_RAM.runs/my_SPI_RAM_myip_slave_lite_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_SPI_RAM_myip_slave_lite_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_SPI_RAM_myip_slave_lite_v1_0_0_0.tcl
