...
HD_PWD='C:/Verilog-lab/my_SPI_RAM/my_SPI_RAM.runs/my_SPI_RAM_spi_slave_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_SPI_RAM_spi_slave_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_SPI_RAM_spi_slave_0_0.tcl
