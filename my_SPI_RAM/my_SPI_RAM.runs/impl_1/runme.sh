...
HD_PWD='C:/Verilog-lab/my_SPI_RAM/my_SPI_RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_SPI_RAM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_SPI_RAM_wrapper.tcl -notrace
