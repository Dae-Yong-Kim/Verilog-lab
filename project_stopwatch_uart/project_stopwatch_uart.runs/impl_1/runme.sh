...
HD_PWD='C:/Verilog-lab/project_stopwatch_uart/project_stopwatch_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rm_ctl_stop_watch_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rm_ctl_stop_watch_top.tcl -notrace
