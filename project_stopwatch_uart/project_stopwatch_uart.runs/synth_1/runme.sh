...
HD_PWD='C:/Verilog-lab/project_stopwatch_uart/project_stopwatch_uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rm_ctl_stop_watch_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rm_ctl_stop_watch_top.tcl
