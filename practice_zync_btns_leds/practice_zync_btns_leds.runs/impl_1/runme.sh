...
HD_PWD='C:/Verilog-lab/practice_zync_btns_leds/practice_zync_btns_leds.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zync_basys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zync_basys_wrapper.tcl -notrace
