...
HD_PWD='C:/Verilog-lab/practice_zync_btns_leds/practice_zync_btns_leds.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zync_basys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zync_basys_wrapper.tcl
