...
HD_PWD='C:/Verilog-lab/practice_zync_btns_leds/practice_zync_btns_leds.runs/zync_basys_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zync_basys_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zync_basys_processing_system7_0_0.tcl
