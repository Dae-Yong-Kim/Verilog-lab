...
HD_PWD='C:/Verilog-lab/my_cnt4/my_cnt4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_cnt4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_cnt4.tcl
