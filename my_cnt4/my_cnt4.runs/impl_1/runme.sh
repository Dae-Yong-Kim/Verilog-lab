...
HD_PWD='C:/Verilog-lab/my_cnt4/my_cnt4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_cnt4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_cnt4.tcl -notrace
